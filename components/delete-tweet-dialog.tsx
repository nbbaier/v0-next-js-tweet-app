...
export function DeleteTweetDialog({ open, onOpenChange, onConfirm, isDeleting, error }: DeleteTweetDialogProps) {
    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          {/* Error message */}
          {error && <div className="mb-4 p-2 text-xs text-red-600 bg-red-50 rounded dark:bg-red-900/20">{error}</div>}
